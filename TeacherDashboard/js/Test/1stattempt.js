...
document.getElementById('file_input').addEventListener('change', handleFileUpload);
...
function handleFileUpload(event) {
    ...
    reader.onload = function(e) {
        ...
        const jsonData = XLSX.utils.sheet_to_json(sheet, {
            range: 3,
            header: ['No', 'Questions', 'Answer1', 'Answer2', 'Answer3', 'Answer4', 'Correct Answer'],
            defval: null
        });
        // Filter out any rows that are empty or have undefined 'No' field
        const filteredData = jsonData.filter(row => row['No'] !== null);
